...
public class Player extends GameObject {
    ...
    public void checkItem() {
        ...
        if(itemHp!=null){
            itemHp.deactive();
            this.hp++;
            Clip hpSound = AudioUtils.loadSound("assets/sound/ItemSound.wav");
            AudioUtils.replay(hpSound);
        }
        ItemShield itemShield = GameObject.findInterSects("ItemShield",this.hitBox,ItemShield.class,this);
        if(itemShield!=null){
            itemShield.deactive();
            shield.reset();
            Clip shieldSound = AudioUtils.loadSound("assets/sound/ItemSound.wav");
            AudioUtils.replay(shieldSound);
        }
    }
